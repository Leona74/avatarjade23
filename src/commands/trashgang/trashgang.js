...
const categories = require("../../data/categories-special.json");
const { stripIndents } = require("common-tags");

module.exports = {
	name: "trashgang",
	description: "Trashgang 歲 help menu.",
	category: "trashgang",
	aliases: [],
	async execute(bot, message, args) {
		...
		embed
			.setTitle(
				`Trashgang 歲 ${message.client.user.username} ${getTargetEmojiByStatus(
